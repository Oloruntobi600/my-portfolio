      ...
      <header className="bg-gray-900 text-white p-6 shadow-lg">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-4">
            +234 703 266 8068 | <a href="mailto:tobiajayi60@gmail.com" className="underline hover:text-blue-400">tobiajayi60@gmail.com</a> | Lagos, Nigeria
          </p>
          <nav>
            <ul className="flex justify-center space-x-6">
              <li>
                <Link href="/about" className="text-lg font-medium hover:text-blue-400 transition">About Me</Link>
              </li>
              <li>
                <Link href="/projects" className="text-lg font-medium hover:text-blue-400 transition">Projects</Link>
              </li>
              <li>
                <Link href="/skills" className="text-lg font-medium hover:text-blue-400 transition">Skills</Link>
              </li>
              <li>
                <Link href="/contact" className="text-lg font-medium hover:text-blue-400 transition">Contact</Link>
              </li>
            </ul>
          </nav>
        </div>
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto flex flex-col items-center">
          ...
          <div className="w-40 h-40 relative mb-6">
            <Image 
              src="/images/portfolio-picture.jpg" // Make sure the image is placed in public/images
